...
if (EMSCRIPTEN)
    # Emscripten only predefines __EMSCRIPTEN__ by default; this codebase's
    # platform guards check the bare EMSCRIPTEN macro, so define it too.
    target_compile_definitions(aurora_core PUBLIC EMSCRIPTEN)
endif ()
...
if (AURORA_ENABLE_GX)
    ...
    target_link_libraries(aurora_core PUBLIC imgui imgui_backends)
endif ()
...
if (AURORA_ENABLE_GX)
    ...
    if (EMSCRIPTEN)
        target_compile_options(aurora_core PUBLIC --use-port=emdawnwebgpu)
        target_link_options(aurora_core PUBLIC --use-port=emdawnwebgpu -sASYNCIFY -sEXIT_RUNTIME)
